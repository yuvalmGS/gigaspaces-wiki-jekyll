...
For more details on how to configure the replication mechanisms of the Space, please refer to [this page]({%latestadmurl%}/replication.html) in the [Administrator's Guide]({%latestjavaurl%}/administrators-guide.html).
{% endinfo %}
