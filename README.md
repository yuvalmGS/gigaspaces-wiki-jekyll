...
* (Optional) If you want to edit a page in the solutions and best practices section: 
  The solutions and best practices section is located in [a separate repository](https://github.com/Gigaspaces/gigaspaces-sbp-jekyll). If you have push permissions to it, clone it into the `sbp` directory as follows:
