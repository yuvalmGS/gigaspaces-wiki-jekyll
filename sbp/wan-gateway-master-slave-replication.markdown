...
You can test the setup by using the [benchmark utility]({%latestjavaurl%}/Benchmark+View+-+GigaSpaces+Browser) comes with the GS-UI. Select the US Benchmark icons and click Start to begin writing objects to the space:
