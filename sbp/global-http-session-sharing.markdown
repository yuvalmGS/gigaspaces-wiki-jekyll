...
h1. Global HTTP Session Sharing - Massive Web Application Scaling
...
h1. What does GigaSpaces Global HTTP Session Management provide?
...
h1. Using GigaSpaces Global HTTP Session Sharing with your Application
...
{code:title=The WEB_INF/web.xml file }
<web-app>
...
{code:title=The WEB_INF/shiro.ini file }
[main]
...
h1. Http Session Web Application Example
