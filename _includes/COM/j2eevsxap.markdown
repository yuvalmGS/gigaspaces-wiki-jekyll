...
|Component|J2EE|XAP|
|:--------|:---|:--|
|Persistency|JPA|[Hibernate]({%latestjavaurl%}/hibernate-external-data-dource.html), [JPA]({%latestjavaurl%}/jpa-support.html)|
...
|Security|JAAS, SSL|[Spring Security]({%latestjavaurl%}/Spring+Security+Bridge), [SSL]({%latestjavaurl%}/securing-the-transport-layer-(using-ssl).html)|
...
|Data Access|JDBC , Session Bean (Stateless or Stateful), Entity Bean|[JDBC]({%latestjavaurl%}/jdbc-driver.html), [Space]({%latestjavaurl%}/the-gigaspace-interface.html), [JPA]({%latestjavaurl%}/jpa-support.html) , Session Bean(Stateless or Stateful) {% star %}, Entity Bean {% star %}|
