...
{% refer %}For more details on transactions, refer to the [Transaction Manager](Transaction Manager) section.{% endrefer %}
...
{% refer %}For more details, refer to the [Benchmark Utility](/xap96/benchmark-utility---gigaspaces-cli.html) section.{% endrefer %}
