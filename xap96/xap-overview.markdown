...
- **[.NET](/xap97net/index.html)**, **[C++](/xap96/xap-cpp.html)** -- GigaSpaces provides .NET and c++ libraries that enable direct interaction with services via the space, just like a POJO client.
