...
For more details on how to configure the replication mechanisms of the Space, refer to [Replication]({% currentjavaurl %}/replication.html) in the [Administrator's Guide](./administrators-guide.html).
{% endinfo %}
