...
{% info %}
For more information, see [Nested Object Queries](./sqlquery.html#Nested Properties)
...
{% note %}
See the [Free Text Search](./sqlquery.html#Free Text Search) section for more details.
{%endnote%}
