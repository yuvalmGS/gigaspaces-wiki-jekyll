...
In the [Mule ESB example](http://wiki.gigaspaces.com/wiki/display/SBP/Mule+ESB+Example), the following jars are required and should be placed under <GigaSpaces Root>\lib\platform\mule
