...
Naturally, the [GigaSpaces Container](./service-grid.html#gsc) implements its own processing unit container, allowing for processing units which are provisioned to it to run properly.
