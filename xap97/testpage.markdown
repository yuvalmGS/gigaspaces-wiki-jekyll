...
You can start XAP's UI console and inspect the cached objects. In the GigaSpace distribution you will find a command file to launch the console.
...
![Console1.png](/attachment_files/Console1.png) ![Console2.png](/attachment_files/Console2.png) ![Console3.png](/attachment_files/Console3.png) ![Console4.png](/attachment_files/Console4.png)
