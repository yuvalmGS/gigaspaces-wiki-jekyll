...
The following example uses the JavaSpaces API, writes 1,000 Entries into the space in [FIFO mode](./fifo-support.html), 1K each, and reads them back into the client three times.
