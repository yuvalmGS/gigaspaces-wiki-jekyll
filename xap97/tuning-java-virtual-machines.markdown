...
{% tip %}
For more details, see [Moving into Production Checklist JVM Tuning](http://wiki.gigaspaces.com/wiki/display/SBP/Moving+into+Production+Checklist.html#JVMTuning).
{% endtip %}
