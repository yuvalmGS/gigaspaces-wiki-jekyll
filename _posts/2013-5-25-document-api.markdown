...
If POJO model cannot be replaced with Document model, yet some level of schema evolution is desired within the POJO model, [Dynamic Properties](/xap96/2013/07/15/dynamic-properties.html) can be used.
...
You can use the [SQLQuery](/xap96/2013/07/21/sqlquery.html) to search for matching `SpaceDocument` entries.
...
For more information about indexing, see the [Indexing](/xap96/2013/05/25/indexing.html) page.
...
[FIFO support](/xap96/2013/02/13/fifo-support.html) is off by default with `Document` entries (same as with POJO). To enable FIFO support, modify the type introduction code and set the desired FIFO support mode. For example:
...
For more information about FIFO, see the [FIFO Support](/xap96/2013/02/13/fifo-support.html) page.

# Transactions and Optimistic Locking

Transactions and isolation modifiers semantics is identical to the POJO semantics. For more information about transactions, see the [Transaction Management](/xap96/2013/04/17/transaction-management.html) page.
...
For more information about optimistic locking, see the [Optimistic Locking](/xap96/2011/11/15/optimistic-locking.html) page.

# Local Cache / Local View

[Local View](/xap96/2013/04/03/local-view.html) and [Local Cache](/xap96/2013/04/08/local-cache.html) are supported for Documents. By default, the `SpaceDocument` instance is stored in the cache which speeds up query performance since the data does not need to be transformed from internal structure to `SpaceDocument`.

If you intend to use local cache or local view in a mixed POJO-Document environment, please refer to [Document-POJO Interoperability](/xap96/2011/11/07/document-pojo-interoperability.html).
...
If you intend to use space filters in a mixed POJO-Document environment, please refer to [Document-POJO Interoperability](/xap96/2011/11/07/document-pojo-interoperability.html).
