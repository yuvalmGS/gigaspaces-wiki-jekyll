...
{refer}It is assumed that you have read the [GigaSpaces CPP API Hello World Example](/xap96/2012/04/12/cpp-api-hello-world-example.html) which serves as a starting point.{refer}
...
For more information on setting the environment refer to [Installing C++ Package](/xap96/2013/04/03/installing-cpp-api-package.html#Setting the Environment).
