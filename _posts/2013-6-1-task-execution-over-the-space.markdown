...
{% tip %}
The following [example](SBP:Map-Reduce Pattern - Executors Example) demonstrates how to use the task execution API
{% endtip %}
...
{% tip %}
See the [Elastic Distributed Risk Analysis Engine](SBP:Elastic Distributed Calculation Engine) for a full `ExecutorBuilder` API example.
{% endtip %}
...
See the [Aggregators](/xap96/2013/06/02/aggregators.html) section for more details.
