...
Starting with version 8.0, GigaSpaces provides the [Document API](/xap96/2013/05/25/document-api.html), which is schema free, and enables users to add properties freely without worrying about the schema. However, some users still prefer to continue working with POJO but would like to enjoy the benefits of dynamic properties.
...
- Dynamic properties can be indexed similar to fixed properties. For more info see [Indexing](/xap96/2013/05/25/indexing.html).
