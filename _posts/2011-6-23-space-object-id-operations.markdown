...
{% tip %}
See the [Global ID Generator](SBP:Global ID Generator) for a generic ID generator service you may use with your application.
{% endtip %}

{% infosign %} To learn how to read space entries by ID see [ID Queries](ID Queries).
