...
{refer}It is assumed that you have read the [GigaSpaces C++ Hello World example](/xap96/2012/04/12/cpp-api-hello-world-example.html) which serves as a starting point.{refer}
