...
{% note %}
**Exclusivity** 
The selected group is locked until the operation is terminated- the operation transaction is committed/ aborted.  See the [Exclusivity](/xap96/2013/01/23/fifo-grouping.html#Exclusivity) section for more elaborations.
{% endnote %}
...
- FG is not supported with a Space using [LRU Cache policy](/xap96/2012/12/19/lru-cache-policy.html) and [Space Persistency](/xap96/2012/12/30/space-persistency.html) enabled.
