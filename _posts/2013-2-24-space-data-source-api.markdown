...
{% info %}
Persisting data to the data is explained in the [Space Synchronization Endpoint API](/xap96/2013/02/25/space-synchronization-endpoint-api.html) page.
{% endinfo %}
...
The [SpaceDataSource](http://www.gigaspaces.com/docs/JavaDoc9.6/index.html?com/gigaspaces/datasource/SpaceDataSource.html) abstract class should be extended in order to provide a custom behavior where needed.
