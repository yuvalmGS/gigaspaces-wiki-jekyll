...
{% info %}
This page assume prior knowledge of multi-space replication, please refer to [Multi-Space Replication](/xap96/2013/01/25/multi-space-replication-over-the-lan-or-vpn.html) before reading this page.
{% endinfo %}
...
After meting the condition specified in the previous, the bootstrap should be initiated using the [Admin API](/xap96/2013/05/06/administration-and-monitoring-api.html).
