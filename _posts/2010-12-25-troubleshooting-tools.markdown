...
- Extract the *[zip](/attachment_files/winJVMDumper.zip)* under `Gigaspaces root dir/bin`. 
...
{% infosign %} See [Packet Sniffer/Network Analyzer Tool](/xap96/2013/03/03/how-to-configure-multicast.html#Packet Sniffer/Network Analyzer Tool) section for more details. 
...
{% infosign %} Download the Send.Signal EXE file from **[HERE](/attachment_files/SendSignal.zip)** or from the [project webpage](http://www.latenighthacking.com/projects/2003/sendSignal/)
...
In order to correlate events from different log files and visualize it you have to create a Log Correlation which is where the **[Eclipse Log and Trace Analyzer component (TPTP LTA)](/attachment_files/Eclipse TPTP - Log And Trace Analyzer.doc)** shines. This component is an extensive and extendable framework that includes built in probes mechanism.
