...
{refer}For the space list CLI, please refer to the [space list - GigaSpaces CLI](/xap96/2009/12/08/space-list---gigaspaces-cli.html) section.{refer}
...
{toc-zone:location=top|type=flat|separator=pipe|minLevel=2|maxlevel=2}
...
For defaults and configuration options, refer to [Jini Lookup Service configuration](/xap96/2012/10/09/lookup-service-configuration.html) settings for `minMaxServiceLease` property.
