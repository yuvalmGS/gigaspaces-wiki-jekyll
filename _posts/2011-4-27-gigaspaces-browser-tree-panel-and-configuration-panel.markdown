...
- **Objects Count** -- the number of objects in the space.
   ...
   {% exclamation %} The **Objects Count** column does not display the number of objects for persistent spaces running in LRU mode (this might result in very high CPU usage). To change this, see the [Menus and Buttons](/xap96/2013/07/10/gigaspaces-browser-menus-and-buttons.html#Display Persistent LRU Space Metrics) section.
...
This column is highlighted in orange if the space memory usage is more than the minimum (low) watermark percentage and lower than the write only block percentage (defined in the [memory usage tag](/xap96/2013/02/19/memory-management-facilities.html)), for example:
...
This column is highlighted in red if the space memory exceeds the write only block percentage (defined in the [memory usage tag](/xap96/2013/02/19/memory-management-facilities.html)), for example:

{% indent %}
![space_network_view_memoryUsage_red_6.5.jpg](/attachment_files/space_network_view_memoryUsage_red_6.5.jpg)
{% endindent %}

{refer}For more details on memory usage, refer to the [Memory Management](/xap96/2013/02/19/memory-management-facilities.html) section.{refer}
...
- **Runtime Configuration Report** -- displays the current configuration of the selected space container (see [Runtime Configuration Report](/xap96/2011/04/12/space-container-maintenance---gigaspaces-browser.html#Runtime Configuration Report)).
- **Launch JConsole** -- launches a [JConsole](/xap96/2011/04/27/space-jmx-management.html) for the selected space container.
...
- [Classes view](/xap96/2011/10/16/data-types-view---gigaspaces-browser.html)
- [Query view](/xap96/2011/04/12/query-view---gigaspaces-browser.html)
- [Statistics view](/xap96/2010/04/12/statistics-view---gigaspaces-browser.html)
- [Benchmark view](/xap96/2011/04/27/benchmark-view---gigaspaces-browser.html)
- [Transactions view](/xap96/2011/04/12/transactions-view---gigaspaces-browser.html)
- [Connections view](/xap96/2011/04/12/connections-view---gigaspaces-browser.html)
...
{refer}For more details, refer to the [Cluster View](/xap96/2011/04/27/cluster-view---gigaspaces-browser.html) section.{refer}
