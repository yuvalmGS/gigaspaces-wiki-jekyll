...
{% info %}
This page covers details which are specific to asynchronous replication which are not covered in the [Replication](/xap96/2011/11/20/replication.html) page, the previous page should be read before this one.
{% endinfo %}
