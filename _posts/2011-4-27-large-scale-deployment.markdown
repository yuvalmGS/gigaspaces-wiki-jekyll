...
{refer}For details on how to disable the space container `RMIRegistry`, refer to the [Overwriting Default Configuration](Overriding Default Configuration) section.{refer}
...
{refer}For more details, refer to the [Viewing Clustered Space Status](/xap96/2010/12/25/viewing-clustered-space-status.html) section.{refer}
