...
{% tip %}
Data resolution occurs between two different clusters using the WAN gateway as a replication channel. In this case a [conflict resolution](/xap96/2012/06/11/multi-site-conflict-resolution.html) is executed.
{% endtip %}
