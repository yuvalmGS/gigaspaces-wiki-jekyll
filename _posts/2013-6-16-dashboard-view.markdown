...
To filter by application, the events time line is also available in the Application tab. (see [Application View#Events time-line (per application)](/xap96/2013/06/16/application-view.html#Events time-line (per application)))
