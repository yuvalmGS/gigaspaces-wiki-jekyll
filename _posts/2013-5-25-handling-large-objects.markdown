...
{% tip %}
The `com.gs.transport_protocol.lrmi.maxBufferSize` system property controls the chunk size. See the [Communication Protocol](/xap96/2013/05/08/communication-protocol.html#maxBufferSize) for details.
{% endtip %}
