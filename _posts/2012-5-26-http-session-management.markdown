...
{% tip %}
For global HTTP Session Managment for Tomcat , JBoss , Weblogic , Websphere , Glassfish and other J2EE web/application servers see the [Global Http Session Sharing](/xap96/2012/05/26/global-http-session-sharing.html).
{% endtip %}
...
{% tip %}
See the [Quick Start Guide](/xap96/2013/04/03/step-2---enabling-http-session-failover-and-fault-tolerance.html) for an example how to use the HTTP Session Management.
{% endtip %}
