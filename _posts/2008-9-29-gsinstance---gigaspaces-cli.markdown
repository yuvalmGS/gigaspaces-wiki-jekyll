...
{% tip %}
GigaSpaces supports space monitoring and management using JMX - The Java Management Extensions. For more details, refer to the [JMX Management](/xap96/2011/04/27/space-jmx-management.html) section. 
{% endtip %}
