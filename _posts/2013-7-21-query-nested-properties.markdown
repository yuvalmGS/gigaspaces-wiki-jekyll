...
The [SQL Query](/xap96/2013/07/21/sqlquery.html) page shows how to express complex queries on flat space entries (i.e entries which are composed of scalar types like integers and strings), but in reality space entries are often composed of more complex types. 
...
An application would likely need to execute queries which involve such properties (e.g. a person which lives in city X, or is part of some group Y, or has a specific home phone number). This page explains how GigaSpaces [SQLQuery](/xap96/2013/07/21/sqlquery.html) can be used to express such queries.
...
{% plus %} For more information see the [Nested Properties Indexing](/xap96/2013/05/25/indexing.html#Nested Properties Indexing) section under [Indexing](/xap96/2013/05/25/indexing.html).
...
{% plus %} For more information see the [Collection Indexing](/xap96/2013/05/25/indexing.html#Collection Indexing) section under [Indexing](/xap96/2013/05/25/indexing.html).
