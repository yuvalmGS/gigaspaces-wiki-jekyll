...
{refer}To learn more about GigaSpaces port usage, refer to [How to Control the Used Ports](/xap96/2012/10/09/how-to-control-the-used-ports.html).{refer}
...
{refer}For more details on the LRMI communication protocol, see the [Communication Protocol](/xap96/2013/05/08/communication-protocol.html) section.{refer}
