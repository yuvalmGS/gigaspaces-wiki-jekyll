...
A Cassandra based implementation of the [Space Data Source](/xap96/2013/02/24/space-data-source-api.html).
...
also asynchronously persists the data using a mirror (see [Cassandra Space Synchronization Endpoint](/xap96/2012/12/28/cassandra-space-synchronization-endpoint.html)).
