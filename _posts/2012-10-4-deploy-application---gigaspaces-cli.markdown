...
Deploys an [application](/xap96/2013/02/21/deploying-onto-the-service-grid.html#Application Deployment and Processing Unit Dependencies), which deploys one or more processing units in dependency order onto the service grid. 

{% tip %}
For undeploying an application see [undeploy-application ](/xap96/2012/06/06/undeploy-application---gigaspaces-cli.html) command.
{% endtip %}
