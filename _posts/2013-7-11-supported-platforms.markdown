...
{space-num-version-code:hsize=2|prefix=Supported Platforms for GigaSpaces|suffix=}

**Navigate to the required category**: {toc-zone:minLevel=1|maxLevel=1|type=list|location=top}

# Overview

GigaSpaces [Data Grid and Messaging Grid core middleware](/xap96/2011/10/02/product-architecture.html#ProductArchitecture-CoreMiddleware), [Database Cache and Persistency](/xap96/2013/05/25/persistency.html), [Service Grid and OpenSpaces](/xap96/2011/10/02/product-architecture.html#OpenSpaces - API and Components) are 100% [Java technology](http://java.sun.com) based.
