...
{% infosign %} Attached is another [**presentation**](/attachment_files/Service-grid-FDH and SplitBrain.pdf) which will illustrate it. For more general details and definition of the Split-Brain please refer to [Split-Brain and Active Election - General Definition](/xap96/2011/12/16/split-brain-and-active-election---general-definition.html) page.
...
[information on the GSM PU Fault Detection Handler](/xap96/2013/08/26/configuring-the-processing-unit-sla.html#ConfiguringtheProcessingUnitSLA-MonitoringtheLivenessofProcessingUnitInstances) is available.

2) **Active Election mechanism**:
This is a mechanism which basically [controls the failure detection of a primary space and the process of moving a backup space into a primary space state](/xap96/2011/12/16/split-brain-and-active-election---general-definition.html).
...
Having one specific primary machine and one specific backup machine could be achieved by using [Zone configurations](/xap96/2013/08/26/configuring-the-processing-unit-sla.html).
...
{% infosign %} This [SpaceModeTest.java source](/attachment_files/SpaceModeTest.java) file is an example of how to determine the status of your spaces using the [Administration and Monitoring API](/xap96/2013/05/06/administration-and-monitoring-api.html). 
...
{% infosign %} Please refer to [Suggested Monitoring Tools](/xap96/2010/03/04/suggested-monitoring-tools.html) section for more details on recommended tools.
