...
- **Color Settings** -- opens the Preferences Panel, allowing you to choose change the default colors of the operations shown in the [Statistics View](/xap96/2010/04/12/statistics-view---gigaspaces-browser.html).
...
The **System Properties** option opens a window listing all configured [system properties](/xap96/2012/07/17/system-properties-list.html). The Configured System Properties window allows you to edit existing system properties, and add new properties.
...
- **Online Help** -- opens the [GigaSpaces Online Help homepage](/xap96/2013/07/10/xap-9.6-documentation-home.html).
...
| ![help.gif](/attachment_files/help.gif) | Opens the [GigaSpaces Online Help homepage](/xap96/2013/07/10/xap-9.6-documentation-home.html) |
