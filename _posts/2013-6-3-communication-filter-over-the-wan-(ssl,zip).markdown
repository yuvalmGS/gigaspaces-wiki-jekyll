...
For both cases there are two built-in [LRMI](/xap96/2013/05/08/communication-protocol.html) [Filters](/xap96/2011/08/26/securing-the-transport-layer-(using-ssl).html).
