...
{% infosign %} When using multicast please review the following section **[How to Determine Whether Multicast is Available](/xap96/2008/09/08/how-to-determine-whether-multicast-is-available.html)** and [How to Configure Multicast](/xap96/2013/03/03/how-to-configure-multicast.html).
...
{% tip %}
If you are looking for a way to use a unicast discovery, please refer to the [How to Configure Unicast Discovery](/xap96/2012/10/09/how-to-configure-unicast-discovery.html) section for more details.
{% endtip %}
...
Using the [list LUS ](/xap96/2011/04/27/list---gigaspaces-cli.html#list-6.0-ListsallactiveJiniLookupServiceinstancesandtheirattributes) CLI option, run from `<GigaSpaces Root>\bin\gs.bat/sh`, you can search for available Jini Lookup Services in the network.
...
{% tip %}
 For details on multi-network card configuration, refer to: [How to Configure an Environment With Multiple Network-Cards (Multi-NIC)](/xap96/2011/04/02/how-to-configure-an-environment-with-multiple-network-cards-(multi-nic).html).
{% endtip %}
