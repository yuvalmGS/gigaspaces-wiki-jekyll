...
-  [com.j_spaces.core.cluster.IReplicationFilterEntry](http://www.gigaspaces.com/docs/JavaDoc9.6/index.html?com/j_spaces/core/cluster/IReplicationFilterEntry.html) -- stores the space object data that is passed into the `IReplicationFilter`.
...
{% tip %}
 you can **control the replication at the operation level, using configuration only**. For more details, refer to the [Replication Operations](/xap96/2013/05/25/replication-operations.html) section.
{% endtip %}
