...
{% lampon %} If you are using the **notification slow consumer** mechanism see the [Slow Consumer](/xap96/2011/02/09/slow-consumer.html#Configuration -- Server Side) for additional LRMI parameters to configure.
