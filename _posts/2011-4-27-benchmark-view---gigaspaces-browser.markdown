...
{refer}For more details on transactions, refer to the [Transaction Manager](Transaction Manager) section.{refer}
...
{refer}For more details, refer to the [Benchmark Utility](/xap96/2011/04/27/benchmark-utility---gigaspaces-cli.html) section.{refer}
