...
To use the Object Inspector, either right click the object you would like to view (from the list of objects displayed in the [Query view](/xap96/2011/04/12/query-view---gigaspaces-browser.html) or in the [Transactions view](/xap96/2011/04/12/transactions-view---gigaspaces-browser.html)) and select **Object Inspector**, or double-click it.
