...
{% tip %}
You can find a fully running [C++ PU example](/xap96/2010/04/30/gigaspaces-cpp-processing-unit-example.html) with source code, build scripts and running instructions.
{% endtip %}
...
See more details about the [Space URL](/xap96/2012/05/20/space-url.html).
