...
The standalone processing unit container is built around Spring's `ApplicationContext` with several extensions relevant to GigaSpaces, such as `[ClusterInfo](/xap96/2012/12/17/obtaining-cluster-information.html)`.
