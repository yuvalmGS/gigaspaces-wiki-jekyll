...
{% tip %}
To setup a production environment see the [Moving into Production Checklist](SBP:Moving into Production Checklist).
{% endtip %}
...
1. Ping the space by running the `<GigaSpaces Root>\bin\gs.bat/sh` utility:
...
You have the following options:
    - Make sure your network and machines running GigaSpaces are configured to have multicast enabled. See the [How to Configure Multicast](/xap96/2013/03/03/how-to-configure-multicast.html) section for details on how to enable multicast. 
...
{refer}**[Get Started with GigaSpaces Tutorials](/xap96/2012/07/16/quick-start-guide.html)**{refer}
