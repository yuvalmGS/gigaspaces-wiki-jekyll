...
{% compositionsetup %}
{% summary page %}This page explains how to start and use a XAP [Data Grid](/xap96/2013/05/25/the-in-memory-data-grid.html) from within another Java process, catering to quick and self-sufficient embedding of XAP within another, external application.{% endsummary %}
...
Once all agents have started, you can issue a few simple API calls from within your application code to bootstrap the data grid and interact with it, by using the [GigaSpaces Elastic Middleware](/xap96/2013/05/25/elastic-processing-unit.html) capabilties.
...
A GigaSpaces node is best facilitated through the use of a service called the "[Grid Service Agent](/xap96/2012/06/05/the-grid-service-agent.html)", or GSA.
...
- [Elastic Processing Unit](/xap96/2013/05/25/elastic-processing-unit.html)
- [Modeling and Accessing Your Data](/xap96/2013/08/28/modeling-and-accessing-your-data.html)
- [Deploying and Interacting with the Space](/xap96/2013/03/30/deploying-and-interacting-with-the-space.html)
- [The GigaSpaces Runtime Environment](/xap96/2012/09/02/the-runtime-environment.html)
