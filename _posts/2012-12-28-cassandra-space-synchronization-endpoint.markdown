...
A Cassandra based implementation of the [Space Synchronization Endpoint](/xap96/2013/02/25/space-synchronization-endpoint-api.html).
...
For more details about different configurations see [Space Persistency](/xap96/2012/12/30/space-persistency.html).
...
|:-------|:----------|
|hectorClient|A configured [HectorCassandraClient](http://www.gigaspaces.com/docs/JavaDoc9.6/index.html?org/openspaces/persistency/cassandra/HectorCassandraClient.html) bean. see [Hector Cassandra Client](/xap96/2012/12/11/hector-cassandra-client.html).|
|fixedPropertyValueSerializer|see [Property Value Serializer](/xap96/2012/12/28/cassandra-space-synchronization-endpoint.html#Property Value Serializer).|
|dynamicPropertyValueSerializer|see [Property Value Serializer](/xap96/2012/12/28/cassandra-space-synchronization-endpoint.html#Property Value Serializer).|
|flattenedPropertiesFilter| see [Flattened Properties Filter](/xap96/2012/12/28/cassandra-space-synchronization-endpoint.html#Flattened Properties Filter).|
|columnFamilyNameConverter| see [Column Family Name Converter](/xap96/2012/12/28/cassandra-space-synchronization-endpoint.html#Column Family Name Converter).|
