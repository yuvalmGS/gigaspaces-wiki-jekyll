...
- **Query** -- opens the [Query view](/xap96/2011/04/12/query-view---gigaspaces-browser.html) with the selected Data Type content in the result table, where each Entry is displayed in a separate row.
