...
{refer}[How to Set GigaSpaces Over a Firewall](/xap96/2012/10/09/how-to-set-gigaspaces-over-a-firewall.html){refer}
...
{refer}[GigaSpaces Java API Documentation](http://www.gigaspaces.com/wiki/display/API/API+Documentation+Portal){refer}
