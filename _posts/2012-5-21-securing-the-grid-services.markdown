...
{refer}[Grid Service Agent](/xap96/2012/06/05/the-grid-service-agent.html){refer}
...
{refer}[Grid Service Manager](/xap96/2011/09/07/the-grid-service-manager.html){refer}
...
{refer}[Grid Service Container](/xap96/2013/03/18/the-grid-service-container.html){refer}
