...
The default log output formatting is determined by `GSSimpleFormatter` (see [Formatting Log Messages](/xap96/2009/07/16/formatting-log-messages.html)).
...
For more information see [Backing-up Files With a Custom Policy](/xap96/2009/07/16/backing-up-files-with-a-custom-policy.html)
