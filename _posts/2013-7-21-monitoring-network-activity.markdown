...
{% compositionsetup %}
{% summary %}Monitoring network and usage activity used by the [LRMI](/xap96/2013/05/08/communication-protocol.html) layer between GigaSpaces component.{% endsummary %}
