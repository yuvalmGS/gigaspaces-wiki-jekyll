...
{refer}For more info refer to [Replication Topologies](/xap96/2013/05/01/replication-topologies.html){refer}
...
There are many parameters that configure the replication behavior. For a full list of the parameters see [Replication Parameters](/xap96/2012/10/14/replication-parameters.html).

## Monitoring and Statistics

The replication module can be monitored and exposes various statistics using the [Administration and Monitoring API](/xap96/2013/05/06/administration-and-monitoring-api.html) via {javadoc-no-frames:com/j_spaces/core/filters/ReplicationStatistics.html|Replication Statistics}
