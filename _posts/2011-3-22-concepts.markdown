...
GigaSpaces XAP extends template matching by providing semantics to query ranges on information as well. For additional information, please refer to the [SQLQuery API](/xap96/2013/07/21/sqlquery.html) in the Programmer's Guide.
{% endtip %}
...
{toc-zone}
{% whr %}
{refer}**Next Chapter:** [A Typical SBA Application](/xap96/2011/06/09/a-typical-sba-application.html){refer}
