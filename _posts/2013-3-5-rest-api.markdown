...
{% section %}
{% column %}
The REST API exposing HTTP based interface Space. It is leveraging the [GigaSpace API](/xap96/2013/08/26/the-gigaspace-interface.html). It support the following methods:
...
4.[Deploy](/xap96/2012/07/02/deploy---gigaspaces-cli.html) the war file. 
