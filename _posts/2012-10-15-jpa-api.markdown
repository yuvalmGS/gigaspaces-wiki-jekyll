...
It is also recommended that you take the [XAP PetClinic JPA Tutorial](/xap96/2013/08/19/your-first-jpa-application.html) which describes how a standard JPA application (the Spring PetClinic) can be adapted to XAP JPA and deployed on to the XAP runtime environment
{% endinfo %}
...
{% info %}
Information regarding Entities declaration can be found [here](/xap96/2012/10/15/jpa-api.html#GigaSpaces JPA Entities)
{% endinfo %}
...
Examples can be found on the [JPA Relationships](/xap96/2012/02/03/jpa-relationships.html) page.
{% endinfo %}
...
For auto generated Id declaration and complex object Id declaration refer to [JPA Entity Id](/xap96/2011/06/23/jpa-entity-id.html).
...
One of the nice benefits of the GigaSpaces JPA implementation is that its fully interoperable with the GigaSpaces [native POJO API](/xap96/2013/03/12/pojo-support.html).
...
- SQLQuery syntax-like queries ([SQLQuery](/xap96/2013/07/21/sqlquery.html)).
- GigaSpaces Tasks ([Task Execution over the Space](/xap96/2013/06/01/task-execution-over-the-space.html)).
- GigaSpaces Dynamic Scripts ([Dynamic Language Tasks](/xap96/2009/08/31/dynamic-language-tasks.html)).
...
For more details on the SQLQuery syntax, refer to the [SQLQuery](/xap96/2013/07/21/sqlquery.html) page.
...
For more information about GigaSpaces tasks refer to [Task Execution over the Space](/xap96/2013/06/01/task-execution-over-the-space.html).
...
For more information about dynamic script execution refer to [Dynamic Language Tasks](/xap96/2009/08/31/dynamic-language-tasks.html).

# GigaSpaces JPA Limitations

For a list of unsupported JPA features and limitations please refer to [GigaSpaces JPA Limitations](/xap96/2011/04/03/gigaspaces-jpa-limitations.html).
