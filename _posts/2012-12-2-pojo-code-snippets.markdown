...
{% lampon %} Space operations with POJO objects can be conducted using the {JavaDocOS:org/openspaces/core/GigaSpace|org.openspaces.core.GigaSpace} interface or the [com.j_spaces.core.IJSpace](http://www.gigaspaces.com/docs/JavaDoc9.6/index.html?com/j_spaces/core/IJSpace.html) interface.

{% lampon %} **The code snippets below use the** {JavaDocOS:org/openspaces/core/GigaSpace|org.openspaces.core.GigaSpace} interface that is the recommended interface.
...
{% note %}
When using the SQLQuery with bigger/less than queries, turn on the [extended indexing](/xap96/2013/05/25/indexing.html#ExtendedIndexing).
{% endnote %}
{% endtabcontent %}
...
- when the [WriteModifiers.UPDATE_OR_WRITE](http://www.gigaspaces.com/docs/JavaDoc9.6/index.html?com/gigaspaces/client/WriteModifiers.html) modifier is applied, the following returns:
    ...
    - For an unsuccessful operation:
        - an
{JavaDocOS:org/openspaces/core/UpdateOperationTimeoutException|UpdateOperationTimeoutException}
...
- when the [WriteModifiers.WRITE_ONLY](http://www.gigaspaces.com/docs/JavaDoc9.6/index.html?com/gigaspaces/client/WriteModifiers.html) modifier is applied the following returns:
    ...
    - For an unsuccessful operation:
        - an
{JavaDocOS:org/openspaces/core/EntryAlreadyInSpaceException|EntryAlreadyInSpaceException}
is thrown.
...
{JavaDocOS:org/openspaces/core/UpdateOperationTimeoutException|UpdateOperationTimeoutException} **is not returned** as part of the returned array elements.
