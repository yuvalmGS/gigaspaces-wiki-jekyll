...
{% tip %}
**Summary:** {excerpt}GigaSpaces `EXCLUSIVE_READ_LOCK`, `READ_COMMITTED`, `DIRTY_READ`, and `REPEATABLE_READ` modifiers.{excerpt}
**Contents:**
...
{refer}Refer to the [Space Locking and Blocking](/xap96/2013/05/25/space-locking-and-blocking.html) section for GigaSpaces general locking and blocking rules.{refer}
{% note %}
