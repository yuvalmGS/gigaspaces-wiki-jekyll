...
{% exclamation %} Note that this guide is specific to XAP.NET administrators. For instructions for XAP administrators, please refer to the depanlinkXAP Administrator's Guidetengahlinkhttp://wiki.gigaspaces.com/wiki/display/XAP95/Administrator's+Guidebelakanglink.
