...
{% exclamation %} Note that this guide is specific to XAP.NET programmers. For instructions for the XAP Programmer's Guide, please refer to the depanlinkXAP Programmer's Guidetengahlinkhttp://wiki.gigaspaces.com/wiki/display/XAP95/Programmer's+Guidebelakanglink.
