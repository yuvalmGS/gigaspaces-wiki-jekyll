...
- [**Java** Processing Unit]({{ page.url | remove: 'net' }}/Packaging-and-Deployment.html) - has code components in Java, and may contain a space component.
- [**Web** Processing Unit]({{ page.url | remove: 'net' }}/Web-Processing-Unit-Container.html) - contains web applications. This Processing Unit can be packaged as a standard JEE WAR (Web Archive) file, and may contain a space component.
- [**EDG** Processing Unit]({{ page.url | remove: 'net' }}/The-Processing-Unit-Structure-and-Configuration.html#dataOnlyPUs) - contains space component(s) only.
...
- A [**Web** Processing Unit]({{ page.url | remove: 'net' }}/Web-Processing-Unit-Container.html#Deployment) is packaged as a standard JEE WAR file.
